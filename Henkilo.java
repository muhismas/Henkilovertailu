...
public class Henkilo {
    ...
    public boolean equals(Object verrattava){
        ...
        if(this.nimi.equals(verrattavaHenkilo.nimi) && this.syntymaPaiva.equals(verrattavaHenkilo.syntymaPaiva)
                && this.pituus == verrattavaHenkilo.pituus && this.paino == verrattavaHenkilo.paino){
            return true;
        }
        return false;
    }
